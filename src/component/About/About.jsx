...
const About = () => {
  return (
    <div>
      <div className={`sm:w-full h-full sm:-mb-10 sm:h-[750px] relative`} data-aos="fade-up">
        <img
          src={about}
          alt="Amalitech Training"
          className="w-full absolute h-[700px] sm:h-[720px] object-cover"
        />
        <div className="bg-black/50 relative w-full h-[700px] sm:h-[720px]"></div>
