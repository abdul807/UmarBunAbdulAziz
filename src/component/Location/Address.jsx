...
const Address = () => {
  return (
    <section className="sm:mt-50 sm:mb-50 -mb-70 mt-50">
      <div className="max-w-5xl mx-auto  grid grid-cols-1 place-items-center text-center sm:grid-cols-4 gap-10">
        ...
        <div>
          <h1 className="font-bold text-[#06724b] uppercase text-xl">Address </h1>
        ...
        <div className="leading-7">
          <h1 className="font-bold uppercase text-[#06724b] text-xl">Contact </h1>
